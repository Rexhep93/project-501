...
const ART = {
    flag: `<svg viewBox="0 0 100 100"><defs><linearGradient id="g-flag" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="currentColor" stop-opacity="1"/><stop offset="1" stop-color="currentColor" stop-opacity="0.72"/></linearGradient></defs><g><rect x="22" y="10" width="7" height="82" rx="2.5" fill="currentColor"/><circle cx="25.5" cy="10" r="4.5" fill="currentColor"/><path d="M29 14 L78 14 L66 34 L78 54 L29 54 Z" fill="url(#g-flag)"/><path d="M29 14 L78 14 L74 20 L29 20 Z" fill="#ffffff" opacity="0.18"/><path d="M29 48 L70 48 L66 54 L29 54 Z" fill="#000000" opacity="0.12"/></g></svg>`,
    ...
    football: `<svg viewBox="0 0 100 100"><defs><linearGradient id="g-fball" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="currentColor" stop-opacity="0.88"/><stop offset="1" stop-color="currentColor" stop-opacity="1"/></linearGradient></defs><circle cx="50" cy="50" r="38" fill="url(#g-fball)"/><g stroke="#F5F1E8" stroke-width="1.6" stroke-linejoin="round" stroke-linecap="round" fill="none" opacity="0.94"><polygon points="50,34 60,41 56,52 44,52 40,41"/><line x1="50" y1="22" x2="50" y2="34"/><line x1="60" y1="41" x2="72" y2="37"/><line x1="56" y1="52" x2="66" y2="62"/><line x1="44" y1="52" x2="34" y2="62"/><line x1="40" y1="41" x2="28" y2="37"/></g><ellipse cx="38" cy="34" rx="14" ry="6" fill="#ffffff" opacity="0.22"/></svg>`,
    ...
    boot: `<svg viewBox="0 0 100 100"><defs><linearGradient id="g-boot" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="currentColor" stop-opacity="1"/><stop offset="1" stop-color="currentColor" stop-opacity="0.72"/></linearGradient></defs><path d="M18 60 Q18 48 28 46 L42 42 Q48 40 52 36 L62 24 Q66 20 72 22 L82 28 Q88 32 88 40 L88 62 Q88 70 80 70 L26 70 Q18 70 18 62 Z" fill="url(#g-boot)"/><path d="M20 60 Q20 50 30 48 L44 44 Q48 42 52 40 L58 32" stroke="#ffffff" stroke-width="2" fill="none" opacity="0.28" stroke-linecap="round"/><g stroke="currentColor" stroke-width="1.4" stroke-linecap="round" opacity="0.55"><line x1="34" y1="48" x2="48" y2="44"/><line x1="36" y1="54" x2="50" y2="50"/><line x1="38" y1="60" x2="52" y2="56"/></g><rect x="20" y="70" width="70" height="6" rx="2" fill="currentColor"/><g fill="#F5F1E8" opacity="0.7"><circle cx="28" cy="82" r="2.6"/><circle cx="40" cy="82" r="2.6"/><circle cx="52" cy="82" r="2.6"/><circle cx="64" cy="82" r="2.6"/><circle cx="76" cy="82" r="2.6"/></g></svg>`,
