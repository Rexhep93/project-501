...
const ART = {
    ...
    football: `<svg viewBox="0 0 100 100"><text x="50" y="50" text-anchor="middle" dominant-baseline="central" font-size="80">⚽</text></svg>`,
